...
public final class Algorithmus {
  ...
  public static final Color[] SIDES = new Color[] { Color.green, Color.red, Color.blue,
      Color.orange };
  ...
  public static boolean isSameBrick( final Color[] c1, final Color[] c2 ) {
    return isEquals( c1, c2 ) || isEquals( c1, new Color[] { c2[ 1 ], c2[ 2 ], c2[ 0 ] } )
        || isEquals( c1, new Color[] { c2[ 2 ], c2[ 0 ], c2[ 1 ] } );
  }
