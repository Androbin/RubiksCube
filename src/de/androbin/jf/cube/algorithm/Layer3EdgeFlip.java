...
public final class Layer3EdgeFlip
{
	...
	private static void layer3edgeFlip1( final Cube cube, final Color border_d, final Color border_e, final Color border_f )
	{
		/**/ if ( border_d != SIDES[ 2 ] )
		{
			/**/ if ( border_e != SIDES[ 1 ] )
	...
	private static void layer3edgeFlip2( final Cube cube, final Color border_d, final Color border_e, final Color border_f )
	{
		/**/ if ( border_e != SIDES[ 1 ] )
		{
