...
public final class Layer1 {
  ...
  private static void layer1edge( final Cube cube ) {
    for ( final Color c : SIDES ) {
      final Color[] brick = new Color[] { UP, c };
  ...
  private static void layer1corner( final Cube cube ) {
    for ( int s = 0; s < SIDES.length; s++ ) {
      ...
      final Color[] brick = new Color[] { UP, c, d };
  ...
  private static void layer1corner1( final Cube cube, final Color c, final Color d,
      final Color[] edge ) {
    if ( edge[ 1 ] == UP ) {
      cube.rotate( c, 1 );
      cube.rotate( DOWN, 1 );
  ...
  private static void layer1corner2( final Cube cube, final Color c, final Color d,
      final Color[] brick ) {
    Color[] pos = cube.searchBrick( brick );
