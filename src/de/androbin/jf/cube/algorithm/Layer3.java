...
public final class Layer3 {
  ...
  private static void layer3edgePrepare( final Cube cube ) {
    final Color[] brick_c = new Color[] { DOWN, SIDES[ 0 ] };
  ...
  private static void layer3cornerSwap( final Cube cube ) {
    if ( !isSameBrick( new Color[] { DOWN, SIDES[ 0 ], SIDES[ 1 ] },
        cube.getBrickAtEdge( DOWN, SIDES[ 0 ], SIDES[ 1 ] ) ) ) {
      if ( isSameBrick( new Color[] { DOWN, SIDES[ 0 ], SIDES[ 1 ] },
          cube.getBrickAtEdge( DOWN, SIDES[ 1 ], SIDES[ 2 ] ) ) ) {
        cornerSwap( cube, SIDES[ 1 ], SIDES[ 3 ] );
      } else if ( isSameBrick( new Color[] { DOWN, SIDES[ 0 ], SIDES[ 1 ] },
          cube.getBrickAtEdge( DOWN, SIDES[ 2 ], SIDES[ 3 ] ) ) ) {
        cornerSwap( cube, SIDES[ 0 ], SIDES[ 2 ] );
      } else if ( isSameBrick( new Color[] { DOWN, SIDES[ 0 ], SIDES[ 1 ] },
          cube.getBrickAtEdge( DOWN, SIDES[ 3 ], SIDES[ 0 ] ) ) ) {
        cube.rotate( DOWN, -1 );
    ...
    for ( int i = 0; i < 2; i++ ) {
      if ( isSameBrick( new Color[] { DOWN, SIDES[ 1 ], SIDES[ 2 ] },
          cube.getBrickAtEdge( DOWN, SIDES[ 1 ], SIDES[ 2 ] ) ) ) {
        break;
      } else {
