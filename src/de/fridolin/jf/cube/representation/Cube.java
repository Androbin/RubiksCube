...
public interface Cube {
  ...
  /**
   * Gibt den Stein zurück, der die Flächen mit den Farben farbe1, farbe2 und farbe3 an einer Ecke
   * verbindet
   ...
   * Falls farben drei Elemente enthält, ist der Stein ein Eckstein und der Rückgabewert hat
   * ebenfalls drei Werte
   * Falls farben zwei Elemente enthält, ist der Stein ein Kantenstein und der Rückgabewert hat
