...
public final class Stein3d extends TransformGroup
{
	...
	public static final int						animationDuration	= 140;
	private final TransformGroup				transformGroup		= new TransformGroup();
	private Transform3D							lastTransform;
	private final Alpha							a					= new Alpha( 1, Alpha.INCREASING_ENABLE, 0, 0, animationDuration, 0, 0, 0, 0, 0 );
	...
	/**
	 * F�gt eine neue Seitenfl�che hinzu
	 * 
	 * @param x
	 * @param y
	 * @param z
	 ...
	 * @param c
	 */
	private void addBox( final float x, final float y, final float z, final float breite, final float hoehe, final float laenge, final Color c )
	{
	...
	/**
	 * Startet eine Rotation mit den �bergebenen Werten
	 * 
	 * @param axis
	 * @param maxAngle
	 * @param s
	...
	/**
	 * F�gt eine Transformation hinten an die Reihe bisher ausgef�hrter Transformationen an
	 * 
	 * @param t
	 */
	...
	public Stein3d( final Stein stein, final float x, final float y, final float z )
	{
		...
		final BoundingSphere bounds = new BoundingSphere( new Point3d( 0.0, 0.0, 0.0 ), Double.MAX_VALUE );
	...
	/**
	 * F�gt die Transformation, die der Interpolator zuletzt als Animation abgespielt hat,
