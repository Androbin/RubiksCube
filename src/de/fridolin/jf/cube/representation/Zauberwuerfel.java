...
/**
 * Der W�rfel ist so gedreht, dass die mittleren W�rfel jeder Seite folgenderma�en angeordnet sind:
 * oben: wei�
 * vorne: gr�n
 * rechts: rot
 * hinten: blau
...
public final class Zauberwuerfel implements Cube
{
	...
	private static final int[][]	drehbewegungEcke	=
	{
	        { 0, 2 },
	        { 0, 0 },
	        { 2, 0 },
	...
	private static final int[][]	drehbewegungRand	=
	{
	        { 1, 2 },
	        { 0, 1 },
	        { 1, 0 },
	...
	private void rotateX( final int drehung, final int x )
	{
		for ( int i = 0; i < Math.abs( drehung ); i++ )
		{
			...
			for ( int e = imUhrzeigersinn ? 2 : 0; e < 3; e++ )
			{
				...
				{
					zStein1.rotX( false );
					zStein2 = wuerfel[ x + 1 ][ drehbewegungEcke[ j ][ 0 ] ][ drehbewegungEcke[ j ][ 1 ] ];
					wuerfel[ x + 1 ][ drehbewegungEcke[ j ][ 0 ] ][ drehbewegungEcke[ j ][ 1 ] ] = zStein1;
					zStein1 = zStein2;
				}
				...
				{
					zStein1.rotX( false );
					zStein2 = wuerfel[ x + 1 ][ drehbewegungRand[ j ][ 0 ] ][ drehbewegungRand[ j ][ 1 ] ];
					wuerfel[ x + 1 ][ drehbewegungRand[ j ][ 0 ] ][ drehbewegungRand[ j ][ 1 ] ] = zStein1;
					zStein1 = zStein2;
				}
			}
		}
	...
	private void rotateY( final int drehung, final int y )
	{
		for ( int i = 0; i < Math.abs( drehung ); i++ )
		{
			...
			for ( int e = imUhrzeigersinn ? 2 : 0; e < 3; e++ )
			{
				...
				{
					zStein1.rotY( false );
					zStein2 = wuerfel[ drehbewegungEcke[ j ][ 0 ] ][ y + 1 ][ drehbewegungEcke[ j ][ 1 ] ];
					wuerfel[ drehbewegungEcke[ j ][ 0 ] ][ y + 1 ][ drehbewegungEcke[ j ][ 1 ] ] = zStein1;
					zStein1 = zStein2;
				}
				...
				{
					zStein1.rotY( false );
					zStein2 = wuerfel[ drehbewegungRand[ j ][ 0 ] ][ y + 1 ][ drehbewegungRand[ j ][ 1 ] ];
					wuerfel[ drehbewegungRand[ j ][ 0 ] ][ y + 1 ][ drehbewegungRand[ j ][ 1 ] ] = zStein1;
					zStein1 = zStein2;
				}
			}
		}
	...
	private void rotateZ( final int drehung, final int z )
	{
		for ( int i = 0; i < Math.abs( drehung ); i++ )
		{
			...
			for ( int e = imUhrzeigersinn ? 2 : 0; e < 3; e++ )
			{
				...
				{
					zStein1.rotZ( false );
					zStein2 = wuerfel[ drehbewegungEcke[ j ][ 0 ] ][ drehbewegungEcke[ j ][ 1 ] ][ z + 1 ];
					wuerfel[ drehbewegungEcke[ j ][ 0 ] ][ drehbewegungEcke[ j ][ 1 ] ][ z + 1 ] = zStein1;
					zStein1 = zStein2;
				}
				...
				{
					zStein1.rotZ( false );
					zStein2 = wuerfel[ drehbewegungRand[ j ][ 0 ] ][ drehbewegungRand[ j ][ 1 ] ][ z + 1 ];
					wuerfel[ drehbewegungRand[ j ][ 0 ] ][ drehbewegungRand[ j ][ 1 ] ][ z + 1 ] = zStein1;
					zStein1 = zStein2;
				}
			}
		}
	...
	{
		return this.wuerfel[ getX( new Color[]
		{ farbe1, farbe2, farbe3 } ) + 1 ][ getY( new Color[]
		{ farbe1, farbe2, farbe3 } ) + 1 ][ getZ( new Color[]
		{ farbe1, farbe2, farbe3 } ) + 1 ].getFarbenUhrzeigersinnZuerst();
	}
	...
	{
		return this.wuerfel[ getX( new Color[]
		{ farbe1, farbe2 } ) + 1 ][ getY( new Color[]
		{ farbe1, farbe2 } ) + 1 ][ getZ( new Color[]
		{ farbe1, farbe2 } ) + 1 ].getFarbenUhrzeigersinnZuerst();
	}
