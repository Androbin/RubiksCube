...
public final class Drehung
{
	 ...
	 * Wird für den RotationInterpolator verwendet
	 * 
	 * @return
	 */
	...
	public Drehung( final boolean x, final boolean y, final boolean z, final boolean imUhrzeigersinn, final Set<Stein> zuDrehendeSteine )
	{
		this.x = x;
		this.y = y;
		this.z = z;
